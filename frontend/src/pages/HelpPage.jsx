...
const FEATURES = [
  ...
  {
    title: '效率工具箱',
    desc: '50+ 覆盖职场办公、自媒体、学习研究的 AI 工具，模板化一键生成。',
    icon: Wrench,
...
const FAQS = [
  ...
  {
    q: '如何把文章/图片/视频发布到公众号、抖音、快手？',
    a: '在「创作工厂 → 发布中心」，从素材库一键加载历史文章或图片视频素材，选择目标平台（微信公众号/抖音/快手），填写标题、正文与话题后点击「一键发布」。未配置自动发布账号时会自动生成素材包（标题、正文、话题、素材下载链接和分步操作指引），按指引到官方 App 或后台粘贴即可发布；在「账号配置」Tab 填入平台 AppID/AppSecret 后，公众号图文、抖音/快手图片视频可直接自动发布，发布记录可在「发布记录」Tab 查看。',
  },
  {
    q: '如何搭建一个小程序？',
    a: '在「创作工厂 → 小程序工坊」，选择一个模板（电商购物/预约服务/作品展示/效率工具/资讯阅读/自定义），输入项目名称和功能需求，AI 会在 1 分钟左右生成完整微信小程序项目（app.js、app.json、WXML/WXSS/JS 页面四件套）。生成后可在线预览每个文件、复制代码或下载 ZIP 包，用微信开发者工具「导入项目」即可运行，按页面内「部署指引」上传代码、提交审核即可上线。',
  },
  {
    q: '如何生成一个小游戏？',
    a: '在「创作工厂 → 小游戏工坊」，选择玩法模板（贪吃蛇/2048/飞机大战/打砖块/记忆翻牌/俄罗斯方块/扫雷/三消/自定义），输入游戏名称和玩法需求，AI 会在 1-2 分钟生成双版本小游戏：网页版（单文件 HTML，页面内可直接「在线试玩」，下载后双击 index.html 即可在浏览器游玩）；微信小游戏版（wx/ 目录含 game.js/game.json/project.config.json，用微信开发者工具选「小游戏」类型导入即可运行）。游戏列表支持试玩、查看代码、下载 ZIP，页面内「部署指引」提供了从开发者工具导入到提交审核上线的完整流程。',
  },
  {
    q: '如何制作 AI 配音？',
    a: '在「创作工厂 → 配音工坊」，选择场景预设（短视频旁白/广告口播/有声书/新闻播报/儿童故事/自定义），输入文字即可合成配音。支持中文、英文多种音色，可调节语速；长文本会自动分段拼接，一次可合成最多 10000 字。生成后的音频可在线播放、下载 MP3，并自动进入作品广场供大家点赞。',
  },
  {
    q: '如何生成表情包？',
    a: '在「创作工厂 → 表情包工坊」，输入顶部文字和底部文字，选择样式（经典黄底/熊猫白底/公告红底/暗夜黑底/蓝紫渐变/AI 生成）即可生成 1080×1080 标准表情包图片。AI 生成样式会自动绘制场景图并叠加文字；生成后可预览、下载 PNG，并自动进入作品广场。',
  },
  {
    q: '如何安排内容发布排期？',
    a: '在「发布中心 → 排期日历」Tab：点击日历中某一天，创建排期（选平台/类型/计划时间/素材），排期会显示在日历上（不同状态不同颜色）；到点后在列表点「立即发布」执行发布。「数据看板」Tab 提供发布总量、成功率、平台分布和近 30 天趋势图表，帮助你追踪运营效果。',
  },
  {
    q: '作品广场是什么？',
    a: '「创作工厂 → 作品广场」自动聚合全平台的 AI 作品：图片工厂生成的图片、视频工厂的视频、配音工坊的音频、表情包工坊的表情包都会出现在这里。支持按类型筛选、瀑布流浏览、点赞和评论互动，是展示与发现优质创作内容的社区。',
  },
  {
    q: '模板市场里有什么？',
    a: '「创作工厂 → 模板市场」聚合了四大工坊的全部内置模板：小游戏玩法（贪吃蛇/2048/飞机大战等 9 种）、小程序结构（电商/预约/展示等 5 种）、表情包样式（6 种）、配音场景（5 种）。点击任意模板卡片即可直达对应工坊，选中该模板开始创作。',
  },
  {
    q: '如何开启深色模式？',
    a: '点击左侧边栏底部的月亮/太阳按钮即可一键切换深色/浅色主题。你的选择会被记住，首次访问会跟随系统偏好；深色模式下所有页面、图表、编辑器均适配。',
  },
  {
    q: '草稿箱是怎么工作的？',
    a: '配音工坊、表情包工坊等创作页面会在你输入时自动保存草稿（1.5 秒无操作后保存）。回到页面时自动恢复上次未完成的输入，首页「草稿箱」卡片展示全部草稿，可一键继续编辑或删除。生成成功后草稿自动清空。',
  },
]
