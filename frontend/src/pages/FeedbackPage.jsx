...
const FEEDBACK_TYPES = [
  ...
  { id: 'bug', label: 'Bug报告', icon: Bug, color: 'text-red-500' },
  { id: 'suggestion', label: '功能建议', icon: Lightbulb, color: 'text-amber-500' },
  { id: 'praise', label: '点赞表扬', icon: Star, color: 'text-emerald-500' },
]
