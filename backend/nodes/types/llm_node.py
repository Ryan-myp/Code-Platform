...
from ..base import BusinessNode, NodeResult, InputValidator, RequiredFieldsValidator, TypeValidator
...
class LLMNode(BusinessNode):
    ...
    def __init__(self, node_id: str, name: str, description: str,
        ...
        super().__init__(node_id, name, description, input_schema=input_schema, 
                        validators=default_validators + (validators or []))
    ...
    def _get_agent(self):
        ...
        if self._agent_instance is None:
            from main import create_agent_instance, get_model
