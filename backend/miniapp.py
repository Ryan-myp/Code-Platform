...
_GENERATE_SYSTEM = """你是一位资深微信小程序开发工程师，擅长编写完整、规范、可直接运行的小程序代码。
...
6. 数据使用本地 mock（Page data 中硬编码示例数据），不使用云开发
7. 代码要完整可用、注释清晰，样式美观（WXSS 需完整编写）
8. 图片资源使用 https://images.unsplash.com 等占位图或纯色背景
