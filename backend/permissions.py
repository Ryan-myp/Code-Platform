...
PAGES = [
    ...
    {"id": "code-gen", "path": "/code-gen", "label": "代码生成"},
    {"id": "code-review", "path": "/code-review", "label": "代码审查"},
    {"id": "agents", "path": "/agents", "label": "Agent 管理"},
    {"id": "workflows", "path": "/workflows", "label": "工作流管理"},
